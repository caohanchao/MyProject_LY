//
//  SeePathTableViewHeaderFooterView.m
//  ProjectTemplate
//
...
@interface SeePathTableViewHeaderFooterView ()
...
@implementation SeePathTableViewHeaderFooterView

+ (instancetype)headerViewWithTableView:(UITableView *)tableView {
    
    static NSString *ID = @"header";
    SeePathTableViewHeaderFooterView *header = [tableView dequeueReusableHeaderFooterViewWithIdentifier:ID];
    if (header == nil) {
        header = [[SeePathTableViewHeaderFooterView alloc] initWithReuseIdentifier:ID];
...
-(void)SingleTap:(UITapGestureRecognizer*)recognizer {
    ...
    if (_deleagte && [_deleagte respondsToSelector:@selector(seePathTableViewHeaderFooterView:index:)]) {
        [_deleagte seePathTableViewHeaderFooterView:self index:self.idnex];
    }
}
/*
