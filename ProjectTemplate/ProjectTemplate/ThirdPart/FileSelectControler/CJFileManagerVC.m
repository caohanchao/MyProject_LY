...
//    NSString *path5 = [[NSBundle mainBundle] pathForResource:@"移动开发人员绩效考核表V1.2" ofType:@"xls"];
//    NSString *path6 = [[NSBundle mainBundle] pathForResource:@"Sprite Kit编程指南" ofType:@"pdf"];
//    NSString *path7 = [[NSBundle mainBundle] pathForResource:@"Sprite Kit编程指南" ofType:@"zip"];
//    NSString *path7 = [[NSBundle mainBundle] pathForResource:@"【叶孤城】iOS进阶指南" ofType:@"zip"];
//    
...
//    CJFileObjModel *mode5 = [[CJFileObjModel alloc] initWithFilePath:path5];
//    CJFileObjModel *mode6 = [[CJFileObjModel alloc] initWithFilePath:path6];
//    CJFileObjModel *mode7 = [[CJFileObjModel alloc] initWithFilePath:path7];
//    [self.originFileArray addObjectsFromArray:@[mode5,mode6,mode7]];
//    [self.originFileArray addObjectsFromArray:@[mode1,mode2,mode3,mode4,mode5,mode6,mode7]];
    ...
    NSArray *results = [self.originFileArray sortedArrayUsingComparator:^NSComparisonResult(id  _Nonnull obj1, id  _Nonnull obj2) {
    ...
    self.originFileArray = [results mutableCopy];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.isReading) {
        ...
        VeFileViewCell *cell = (VeFileViewCell *)[tableView cellForRowAtIndexPath:indexPath];
        [cell ClickBtnWithSelectCell];
    }
