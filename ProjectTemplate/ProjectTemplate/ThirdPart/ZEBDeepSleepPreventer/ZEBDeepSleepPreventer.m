...
@interface ZEBDeepSleepPreventer ()
...
@implementation ZEBDeepSleepPreventer
...
- (id)init
{
    ...
    NSString *soundFilePath = [[NSBundle mainBundle] pathForResource:@"ZEBSilence"
                                                              ofType:@"wav"];
