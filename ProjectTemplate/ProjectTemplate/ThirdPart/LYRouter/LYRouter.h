...
extern NSString *const LYRouterParameterURL;
extern NSString *const LYRouterParameterCompletion;
extern NSString *const LYRouterParameterUserInfo;
 ...
 *
 *  @param URLPattern 带上 scheme，如 LY://beauty/:id
 *  @param handler    该 block 会传一个字典，包含了注册的 URL 中对应的变量。
 *                    假如注册的 URL 为 LY://beauty/:id 那么，就会传一个 @{@"id": 4} 这样的字典过来
 */
 ...
 *
 *  @param URL 带 Scheme，如 LY://beauty/3
 */
 ...
 *
 *  @param URL        带 Scheme 的 URL，如 LY://beauty/4
 ...
 *
 *  #define LY_ROUTE_BEAUTY @"beauty/:id"
 *  [LYRouter generateURLWithPattern:LY_ROUTE_BEAUTY, @[@13]];
 *
 *
