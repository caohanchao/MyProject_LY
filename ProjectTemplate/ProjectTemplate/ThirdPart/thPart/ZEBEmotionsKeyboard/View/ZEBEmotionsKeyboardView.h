...
extern NSString * const PNGNameKey;
extern NSString * const PNGDatakey;

@class ZEBEmotionsKeyboardView;

/**
 *  表情种类
 */
typedef NS_ENUM(NSUInteger, ZEBEmotionType) {
    /**
     *  gif表情
     */
    ZEBEmotionTypeGIF,
 ...
 *  Emoji表情五种分类
 */
typedef NS_ENUM(NSUInteger, ZEBEmojiType) {
    /**
     *  人
     */
    ZEBEmojiTypePeople,
...
@protocol ZEBEmotionsKeyboardViewDelegate <NSObject>
 ...
 *  @param gif               返回该表情的gif || png字典（两对值，）
 */
- (void)emotionsKeyboardView:(ZEBEmotionsKeyboardView *)emojiKeyboardView
 ...
 *  表情键盘封装view
 */
@interface ZEBEmotionsKeyboardView : UIView

/**
 *  delegate
 */
@property (nonatomic, copy) id<ZEBEmotionsKeyboardViewDelegate> delegate;
...
- (instancetype)initWithFrame:(CGRect)frame
                     delegate:(id<ZEBEmotionsKeyboardViewDelegate>)delegate
...
@interface ZEBGIFPageView : UIView
...
@interface ZEBEmojiPageView : UIView
...
@interface ZEBPNGPageView : UIView

/**
 *  点击png回调
 */
@property (nonatomic, copy) void(^clickPNGEmotionBlock)(id pngData);
