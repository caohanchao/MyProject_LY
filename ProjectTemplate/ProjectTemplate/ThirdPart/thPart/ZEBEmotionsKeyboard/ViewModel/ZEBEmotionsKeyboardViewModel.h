...
extern NSString * const ZEBEmojiTypePeopleKey;
extern NSString * const ZEBEmojiTypeNatureKey;
extern NSString * const ZEBEmojiTypeObjectsKey;
extern NSString * const ZEBEmojiTypePlacesKey;

@interface ZEBEmotionsKeyboardViewModel : NSObject
