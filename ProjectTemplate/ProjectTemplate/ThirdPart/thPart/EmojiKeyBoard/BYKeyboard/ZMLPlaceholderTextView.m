...
static __weak id zmlPlaceholderTextView;

@implementation ZMLPlaceholderTextView (zmlPlaceholderTextView)


+ (id)currentZMLPlaceholderTextView {
    zmlPlaceholderTextView = nil;
    [[UIApplication sharedApplication] sendAction:@selector(findZMLPlaceholderTextView:) to:nil from:nil forEvent:nil];
    return zmlPlaceholderTextView;
}

- (void)findZMLPlaceholderTextView:(id)sender {
    zmlPlaceholderTextView = self;
}
