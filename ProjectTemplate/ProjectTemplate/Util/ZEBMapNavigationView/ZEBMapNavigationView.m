...
#import "CLLocation+ZEBLocation.h"

@interface ZEBMapNavigationView()

@property (nonatomic , strong)UIActionSheet *sheet;

@end

@implementation ZEBMapNavigationView
{
...
- (void)showMapNavigationViewFormcurrentLatitude:(double)currentLatitude currentLongitute:(double)currentLongitute TotargetLatitude:(double)targetLatitude targetLongitute:(double)targetLongitute toName:(NSString *)name{
    ...
    _name = name;
    NSArray *appListArr = [ZEBMapNavigationView checkHasOwnApp];
...
-(void)startLocation
{
    if([CLLocationManager locationServicesEnabled] && [CLLocationManager authorizationStatus] != kCLAuthorizationStatusDenied)
    {
        ...
        [self showMapNavigationViewFormcurrentLatitude:[appDelegate.latitude doubleValue] currentLongitute:[appDelegate.longitude doubleValue] TotargetLatitude:_targetLatitude targetLongitute:_targetLongitute toName:_name];
