//
//  ZEBURLSessionWrapperOperation.m
//  ProjectTemplate
//
...
@interface ZEBURLSessionWrapperOperation () {
...
@implementation ZEBURLSessionWrapperOperation
#pragma mark - Observe Task

+ (instancetype)operationWithURLSessionTask:(NSURLSessionTask*)task {
    ZEBURLSessionWrapperOperation* operation = [ZEBURLSessionWrapperOperation new];
    operation.task = task;
    return operation;
}
