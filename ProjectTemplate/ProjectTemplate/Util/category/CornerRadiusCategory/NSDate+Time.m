...
{
    // Thanks, Jim Morrison
    return [[NSDate date] myDateByAddingDays:days];
}
...
//    ZEBLog(@"c1:%@  c2:%@",components1,components2);
...
- (NSDate *) myDateByAddingDays: (NSInteger) dDays
{
...
{
    return [self myDateByAddingDays: (dDays * -1)];
}
...
- (NSInteger) minuteAfterDate: (NSDate *) aDate
{
    NSTimeInterval ti = [self timeIntervalSinceDate:aDate];
    return (NSInteger) (ti / D_MINUTE);
}
